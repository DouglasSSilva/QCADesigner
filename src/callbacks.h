...
char* get_standard_cell_name (int selected); //Thamara
void use_import_standard_cell_button_clicked (GtkWidget *widget, gpointer data) ; //Thamara
void use_button_clicked (GtkWidget *widget, gpointer data) ; //Thamara
void use_resize_button_clicked (GtkWidget *widget, gpointer data) ; //Thamara
