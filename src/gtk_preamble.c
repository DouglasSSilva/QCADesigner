...
// Done adding pixmap directories
  ...
  //Thamara
  add_stock_icon ("use.svg", 		      QCAD_STOCK_USE) ;
  add_stock_icon ("use-resize.svg",           QCAD_STOCK_USE_RESIZE) ;
  add_stock_icon ("use-auto.svg",             QCAD_STOCK_USE_AUTO) ;
  add_stock_icon ("use-import-sc.svg", 	      QCAD_STCK_USE_IMPORT_SC) ;
  //Thamara
  ...
  //Thamara
  add_stock_icon ("use.png",                  QCAD_STOCK_USE) ;
  add_stock_icon ("use-resize.png",           QCAD_STOCK_USE_RESIZE) ;
  add_stock_icon ("use-auto.png",             QCAD_STOCK_USE_AUTO) ;
  add_stock_icon ("use-import-sc.png",        QCAD_STOCK_USE_IMPORT_SC) ;
  //Thamara
