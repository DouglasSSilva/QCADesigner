...
void create_main_window (main_W *main_window){
  ...
  main_window->use_button =
  gtk_toolbar_append_element (
    GTK_TOOLBAR (layers_toolbar),
    GTK_TOOLBAR_CHILD_BUTTON,
    NULL,
    _("Show/Hide USE clocking scheme"),
    _("Show/Hide USE clocking scheme"),
    _("Show/Hide USE clocking scheme."),
    gtk_image_new_from_stock (QCAD_STOCK_USE, QCAD_ICON_SIZE_TOP_TOOLBAR),
    (GCallback)use_button_clicked, NULL) ;

  main_window->use_resize_button =
  gtk_toolbar_append_element (
    GTK_TOOLBAR (layers_toolbar),
    GTK_TOOLBAR_CHILD_BUTTON,
    NULL,
    _("Configure USE Clocking Scheme Size"),
    _("Configure USE Clocking Scheme Size"),
    _("Configure USE Clocking Scheme Size"),
    gtk_image_new_from_stock (QCAD_STOCK_USE_RESIZE, QCAD_ICON_SIZE_TOP_TOOLBAR),
    (GCallback)use_resize_button_clicked, NULL) ;

  main_window->import_standard_cell_button =
  gtk_toolbar_append_element (
    GTK_TOOLBAR (layers_toolbar),
    GTK_TOOLBAR_CHILD_BUTTON,
    NULL,
    _("Import standard cell"),
    _("Import standard cell"),
    _("Import standard cell"),
    gtk_image_new_from_stock (QCAD_STOCK_USE_IMPORT_SC, QCAD_ICON_SIZE_TOP_TOOLBAR),
    (GCallback)use_import_standard_cell_button_clicked, NULL) ;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  main_window->show_USE_clocking_scheme_menu_item = gtk_check_menu_item_new_with_label (_("Show USE Clocking Scheme"));
  gtk_widget_show (main_window->show_USE_clocking_scheme_menu_item);
  gtk_container_add (GTK_CONTAINER (view_menu_menu), main_window->show_USE_clocking_scheme_menu_item);
  gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (main_window->show_USE_clocking_scheme_menu_item), FALSE);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM(main_window->show_USE_clocking_scheme_menu_item), FALSE);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //Thamara - start
  // create and add a separator in tools menu
  mnuiSep = gtk_menu_item_new ();
  gtk_widget_show (mnuiSep);
  gtk_container_add (GTK_CONTAINER (tools_menu_menu), mnuiSep);
  gtk_widget_set_sensitive (mnuiSep, FALSE);
  // create and add the import standard cell menu item to the tools menu
  main_window->import_standard_cell_menu_item = gtk_image_menu_item_new_with_mnemonic (_("_Import standard cell..."));
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (main_window->import_standard_cell_menu_item),
    img = gtk_image_new_from_stock (QCAD_STOCK_BLOCK_READ, GTK_ICON_SIZE_MENU)) ;
  gtk_widget_show (img) ;
  gtk_widget_show (main_window->import_standard_cell_menu_item);
  gtk_container_add (GTK_CONTAINER (tools_menu_menu), main_window->import_standard_cell_menu_item);
  //Thmara - end
#endif /* def STDIO_FILEIO */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  fault_simulation_start_menu_item = gtk_menu_item_new_with_mnemonic (_("Start Fault Simulation"));
  ...
  //create and add the stop fault simulation menu item to the simulation menu //
  fault_simulation_stop_menu_item = gtk_menu_item_new_with_mnemonic (_("Stop Fault Simulation"));
  gtk_widget_show (fault_simulation_stop_menu_item);
  gtk_container_add (GTK_CONTAINER (simulation_menu_menu), fault_simulation_stop_menu_item);

  // create and add the fault simulation menu item to the simulation menu //
  fault_simulation_setup_menu_item = gtk_menu_item_new_with_mnemonic (_("Fault Simulation Setup..."));
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  g_signal_connect (G_OBJECT (main_window->import_standard_cell_menu_item),    "activate", (GCallback)use_import_standard_cell_button_clicked, NULL); //Thamara
  ...
  g_signal_connect (G_OBJECT (main_window->show_USE_clocking_scheme_menu_item),"activate", (GCallback)on_show_USE_clocking_scheme_menu_item_activate,NULL);
  ...
  g_signal_connect (G_OBJECT (fault_simulation_stop_menu_item),               "activate", (GCallback)on_fault_simulation_stop_menu_item_activate,  NULL);
  ////////////// End of Dayane Alfenas Reis - 09/10/14 - 09:48am
