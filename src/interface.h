...
typedef struct
  ...
  GtkWidget *use_button; //Thamara
  GtkWidget *use_resize_button; //Thamara
  GtkWidget *show_USE_clocking_scheme_menu_item; //Thamara
  ...
  GtkWidget *import_standard_cell_menu_item; //Thamara
  GtkWidget *import_standard_cell_button; //Thamara
